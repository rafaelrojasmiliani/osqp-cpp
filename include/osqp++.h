...
template <typename T = bool> struct Status {
  T value;
  std::string message = "";
...
public:
  ...
  Status<bool> Init(const OsqpInstance &instance, const OsqpSettings &settings);
  ...
  // - OkStatus on success
  Status<bool>
  SetWarmStart(const Eigen::Ref<const Eigen::VectorXd> &primal_vector,
  ...
  // - OkStatus on success
  Status<bool>
  SetPrimalWarmStart(const Eigen::Ref<const Eigen::VectorXd> &primal_vector);
  ...
  // - OkStatus on success
  Status<bool>
  SetDualWarmStart(const Eigen::Ref<const Eigen::VectorXd> &dual_vector);
  ...
  // - OkStatus on success
  Status<bool>
  SetObjectiveVector(const Eigen::Ref<const Eigen::VectorXd> &objective_vector);
  ...
  // - UnknownError if the internal OSQP call fails
  // - OkStatus on success
  Status<bool> SetBounds(const Eigen::Ref<const Eigen::VectorXd> &lower_bounds,
  ...
  Status<std::optional<double>> GetRho() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<c_int>> GetAdaptiveRho() const;
  ...
  // FailedPreconditionError if IsInitialized() is false.
  Status<std::optional<c_int>> GetAdaptiveRhoInterval() const;
  ...
  Status<std::optional<double>> GetAdaptiveRhoTolerance() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<double>> GetAdaptiveRhoFraction() const;
  ...
  Status<std::optional<c_int>> GetMaxIter() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<double>> GetEpsAbs() const;

  // Gets the current value of the eps_rel setting, i.e., the relative error
  // tolerance for convergence. Returns a FailedPreconditionError if
  // IsInitialized() is false.
  Status<std::optional<double>> GetEpsRel() const;
  ...
  // if IsInitialized() is false.
  Status<std::optional<double>> GetEpsPrimInf() const;
  ...
  // if IsInitialized() is false.
  Status<std::optional<double>> GetEpsDualInf() const;
  ...
  Status<std::optional<double>> GetAlpha() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<double>> GetDelta() const;
  ...
  Status<std::optional<bool>> GetPolish() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<c_int>> GetPolishRefineIter() const;
  ...
  Status<std::optional<bool>> GetVerbose() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<bool>> GetScaledTermination() const;
  ...
  // IsInitialized() is false.
  Status<std::optional<c_int>> GetCheckTermination() const;

  // Gets the current value of the warm_start setting, i.e., if warm starting is
  // performed. Returns a FailedPreconditionError if IsInitialized() is false.
  Status<std::optional<bool>> GetWarmStart() const;
  ...
  // is false.
  Status<std::optional<double>> GetTimeLimit() const;

  // Updates the rho setting, i.e., the ADMM rho step. Returns:
  // - FailedPreconditionError if IsInitialized() is false
  // - InvalidArgumentError if rho_new <= 0.0
  // - OkStatus on success
  Status<std::optional<bool>> UpdateRho(double rho_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateMaxIter(int max_iter_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateEpsAbs(double eps_abs_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateEpsRel(double eps_rel_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateEpsPrimInf(double eps_prim_inf_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateEpsDualInf(double eps_dual_inf_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateAlpha(double alpha_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateDelta(double delta_new);

  // Updates the polish setting, i.e., whether polishing is performed. Returns:
  // - FailedPreconditionError if IsInitialized() is false
  // - OkStatus on success
  Status<std::optional<bool>> UpdatePolish(bool polish_new);
  ...
  UpdatePolishRefineIter(int polish_refine_iter_new);

  // Updates the verbose setting, i.e., whether solver output is printed.
  // Returns:
  // - FailedPreconditionError if IsInitialized() is false
  // - OkStatus on success
  Status<std::optional<bool>> UpdateVerbose(bool verbose_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>>
  UpdateScaledTermination(bool scaled_termination_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>>
  UpdateCheckTermination(c_int check_termination_new);

  // Updates the warm_start setting, i.e., whether warm starting is performed.
  // Returns:
  // - FailedPreconditionError if IsInitialized() is false
  // - OkStatus on success
  Status<std::optional<bool>> UpdateWarmStart(bool warm_start_new);
  ...
  // - OkStatus on success
  Status<std::optional<bool>> UpdateTimeLimit(double time_limit_new);
